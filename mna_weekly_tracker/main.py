...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-raw-items", type=int, default=int(os.getenv("MAX_RAW_ITEMS", "160")), help="Maximum raw candidates sent to DeepSeek.")
    parser.add_argument("--max-cases", type=int, default=int(os.getenv("MAX_STRUCTURED_CASES", "80")), help="Maximum structured cases in the Excel.")
