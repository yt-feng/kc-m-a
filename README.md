...
这个仓库用于每周自动整理最新一周的全球并购案例：中国为主，全球为辅；输出格式参考上传的 Excel 案例库，A 列“案例分类”按《并购分类建议（含案例名称）》中的 10 类口径。
...
全球案例使用 Google News RSS 查询，聚焦 merger / acquisition / takeover、cross-border acquisition、SPAC、privatization、buyout，以及中国公司跨境收购。
...
可在此调整并购分类口径、中国官方信息源、关键词、全球 Google News 查询词和 Excel 输出列。
